...
- [NetworkManager IPv6 settings](https://networkmanager.dev/docs/api/latest/settings-ipv6.html)
...
- [systemd-resolved configuration](https://www.freedesktop.org/software/systemd/man/latest/resolved.conf.html)
- [Vivaldi Linux repository setup](https://help.vivaldi.com/desktop/install-update/manual-setup-vivaldi-linux-repositories/)
